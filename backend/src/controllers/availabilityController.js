...
const { AvailabilitySlot, RoomDetail, HealthDetail, VehicleDetail, CourseDetail } = require('../models');
...
module.exports = {
  ...
  async updateSlot(req, res) {
    ...
    const detail = await model.findOne({ where: { Id: slot.ResourceDetailId, ResourceId: slot.ResourceId } });
    ...
    await slot.update({ DayOfWeek: dayOfWeek, StartTime: startTime, EndTime: endTime, StartDate: startDate, EndDate: endDate, IsActive: isActive });
    res.json(slot);
  },
